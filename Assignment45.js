...
var guestList = ["hamza", "sara", "musfira", "lala", "zraa"];
...
guestList.forEach(function (mega) { return console.log("salam ".concat(mega, ", would you like to dinner with me")); });
//Question no.15
while (guestList.length > 2) {
    var removedGuest = guestList.pop();
    console.log("sorry ".concat(removedGuest, "we are not allowed in dinner"));
}
//sending invitation for last two guest
console.log("invitation to the last two guest "),
    guestList.forEach(function (lastTwo) { return console.log("".concat(lastTwo, ", you are still invited to dinner")); });
